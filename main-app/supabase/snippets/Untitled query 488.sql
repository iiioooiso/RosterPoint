...
BEGIN
    ...
    VALUES
        (v_student_id, v_app_1,  'resume', 'resumes/aarav_sharma_resume.pdf',   'Aarav_Sharma_Resume.pdf',   'application/pdf'),
        (v_cand_2,     v_app_2,  'resume', 'resumes/riya_mehta_resume.pdf',     'Riya_Mehta_Resume.pdf',     'application/pdf'),
        (v_cand_3,     v_app_3,  'resume', 'resumes/aditya_verma_resume.pdf',   'Aditya_Verma_Resume.pdf',   'application/pdf'),
        (v_cand_4,     v_app_4,  'resume', 'resumes/ananya_patel_resume.pdf',   'Ananya_Patel_Resume.pdf',   'application/pdf'),
        (v_cand_5,     v_app_5,  'resume', 'resumes/rahul_singh_resume.pdf',    'Rahul_Singh_Resume.pdf',    'application/pdf'),
        (v_cand_6,     v_app_6,  'resume', 'resumes/sneha_joshi_resume.pdf',    'Sneha_Joshi_Resume.pdf',    'application/pdf'),
        (v_cand_7,     v_app_7,  'resume', 'resumes/karan_gupta_resume.pdf',    'Karan_Gupta_Resume.pdf',    'application/pdf'),
        (v_cand_8,     v_app_8,  'resume', 'resumes/neha_kulkarni_resume.pdf',  'Neha_Kulkarni_Resume.pdf',  'application/pdf'),
        (v_cand_9,     v_app_9,  'resume', 'resumes/arjun_rao_resume.pdf',      'Arjun_Rao_Resume.pdf',      'application/pdf'),
        (v_cand_10,    v_app_10, 'resume', 'resumes/ishita_shah_resume.pdf',    'Ishita_Shah_Resume.pdf',    'application/pdf'),
        (v_cand_11,    v_app_11, 'resume', 'resumes/yash_malhotra_resume.pdf',  'Yash_Malhotra_Resume.pdf',  'application/pdf'),
        (v_cand_12,    v_app_12, 'resume', 'resumes/priya_nair_resume.pdf',     'Priya_Nair_Resume.pdf',     'application/pdf'),
        (v_cand_13,    v_app_13, 'resume', 'resumes/vikram_desai_resume.pdf',   'Vikram_Desai_Resume.pdf',   'application/pdf'),
        (v_cand_14,    v_app_14, 'resume', 'resumes/meera_iyer_resume.pdf',     'Meera_Iyer_Resume.pdf',     'application/pdf'),
        (v_cand_15,    v_app_15, 'resume', 'resumes/dev_kapoor_resume.pdf',     'Dev_Kapoor_Resume.pdf',     'application/pdf');
